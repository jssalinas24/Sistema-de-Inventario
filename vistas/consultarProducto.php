...
session_start();
    ...
    $c = new Conexion();
    $cone = $c->conectando();	
    $sql4 = "select nivel.id_nivel from usuario INNER JOIN nivel on usuario.id_nivel = nivel.id_nivel where usuario.nombre_usuario = '$varsesion' ";
    $rs4 = mysqli_query($cone,$sql4);
    $arreglo4 = mysqli_fetch_row($rs4);
    
    if( $arreglo4[0]!=1 and $arreglo4[0]!=2){
...
<html lang="es">
    ...
    <body>
        <center>
            <br>   
                <h3 class="font-weight-normal">Productos</h3>
                <hr style="height:1px;border:none;color:#333;background-color:#333;">
                <form name="producto" action="" method="POST">
                <table>
                    <tr>
                        <td>
                            <a href="agregarProducto.php"><button type="button" class="btn btn-primary btn-sm "><i class="fa fa-file-text-o" aria-hidden="true"></i> Agregar</button></a>
                        <td>
                    </tr>
                    <tr>
                        <td>
                            <a href="../reportes/reporteProductos.php"><button type="button" class="btn btn-dark btn-sm "><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Generar reporte</button></a>
                        <td>
                    </tr>
                    <tr>
                        <th><label for="nombre">Buscar</label></th>
                            ...
                            <th><a href="../graficas/graficaProducto.php"><button type="button" class="btn btn-light btn-sm "><i class="fa fa-pie-chart" aria-hidden="true"></i> Ver gráfica</button></a></th>
                            <th><a href="../menu/home.html"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-sign-out" aria-hidden="true"></i> Salir</button> </th>
                    </tr>
                </table>    
        </center>
        <br>
