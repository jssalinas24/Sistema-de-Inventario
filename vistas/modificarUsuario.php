    ...
    <body>
        <center>
            <form action="" name="usuario" method="POST">
                <table border="1">
                        <tr>
                            <td colspan="2"><center>Modificar Usuario</center></td>
                        </tr>
                        <tr>
                            <td>Código Usuario</td>
                            <td><input size="25" type="number" name="id_usuario" id="id_usuario" value="<?php echo $obj->id_usuario ?>" placeholder="Código automático"></td>
                        </tr>
                        <tr>
                        <tr>
                            <td>Rol</td>
                        ...
                        <tr>
                            <td>Clave</td>
                            <td><input size="25" type="number" name="clave" id="clave" value="<?php echo $obj->clave?>" placeholder="Ingrese clave"></td>
                        </tr>
                        <form action="" method="get" accept-charset="utf-8">
                            <td><input id="myPassword" type="password"  input size="25"  name="clave_usuario" required minlength="8" maxlength="12" size="10" value="<?php echo $obj->clave_usuario ?>" placeholder="Ingrese clave"></td>
                        </form>
