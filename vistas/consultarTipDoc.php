...
session_start();
    ...
    $c = new Conexion();
    $cone = $c->conectando();	
    $sql6 = "select nivel.id_nivel from usuario INNER JOIN nivel on usuario.id_nivel = nivel.id_nivel where usuario.nombre_usuario = '$varsesion' ";
    $rs6 = mysqli_query($cone,$sql6);
    $arreglo6 = mysqli_fetch_row($rs6);
    
    if( $arreglo6[0]!=1 and $arreglo6[0]!=2){
...
<html lang="es">
    <head>
        ...
        <title>Módulo Tipo Documento</title>
    </head>
    <body>
        <center>
            <br>   
                <h3 class="font-weight-normal">Tipo Documento</h3>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <a href="../reportes/reporteTipDocs.php"><button type="button" class="btn btn-dark btn-sm "><i class="fa fa-file-excel-o" aria-hidden="true"></i> Generar reporte</button></a>
                        <td>
                    </tr>
                    <tr>
                        <th><label for="descripcion">Buscar</label></th>
                            <th><input style="font-size:12px" type="text" id="descripcion" name="descripcion" placeholder="Digite el del producto a consultar" size="50" >
                                ...
                                <th>
                                <th><a href="../graficas/graficaDocumento.php"><button type="button" class="btn btn-light btn-sm "><i class="fa fa-pie-chart" aria-hidden="true"></i> Ver gráfica</button></a></th>
        ...
        <center>
            <table class= "table table-dark table-striped table-hover" style="width: 95%">
                    <caption><small>Lista Tipo Documento</small></caption>
                    <thead>
                        <tr class="bg-danger">
