...
if(isset($_POST['consulta'])){
    ...
    $c = new Conexion();
    $cone = $c->conectando();
    $sql = "select * from categoria where id_categoria like '%$obj->id_categoria%'";
...
<html lang="es">
    ...
    <body>
        <center>
          <br>   
            <h3 class="font-weight-normal">Categoría</h3> 
            ...
            <table >
                ...
                <tr>
                        <td>
                            <a href="../reportes/reporteCategorias.php"><button type="button" class="btn btn-dark btn-sm "><i class="fa fa-file-excel-o" aria-hidden="true"></i> Generar reporte</button></a>
                        <td>
                    </tr>
                 <tr>
                        ...
                        <th><a href="../graficas/graficaCategoria.php"><button type="button" class="btn btn-light btn-sm "><i class="fa fa-pie-chart" aria-hidden="true"></i> Ver gráfica</button></a></th>
            ...
            <center>
                <table class="table table-dark table-striped table-hover" style="width: 95%">
                        <caption><small>Lista Categoría</small></caption>  
                        <thead>
                            <tr class="bg-danger">
                                <th scope="col" style="width:10%"  class="text-light letra">Código Categoría</th>
