...
<html lang="es">
    ...
    <body>
        <center>
          <br>   
            <h3 class="font-weight-normal">Clasificación</h3> 
            <hr>
            ...
            <table >
                ...
                <tr>
                        <td>
                            <a href="../reportes/reporteClasificaciones.php"><button type="button" class="btn btn-dark btn-sm "><i class="fa fa-file-excel-o" aria-hidden="true"></i> Generar reporte</button></a>
                        <td>
                    </tr>
                 <tr>
		                <th><label for="id_clasificacion">Buscar</label></th>
		                <th><input style="font-size:14px" type="text" id="id_clasificacion" name="id_clasificacion"placeholder="Digite el Nombre de la clasificacion para Consultar" size="50" >
                        ...
                        <th><a href="../graficas/graficaClasificacion.php"><button type="button" class="btn btn-light btn-sm "><i class="fa fa-pie-chart" aria-hidden="true"></i> Ver gráfica</button></a></th>
