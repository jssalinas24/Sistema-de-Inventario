...
//SELECT a.nombre_usuario, a.clave_usuario, b.nombreNivel FROM usuarios a, niveles b WHERE  a.codigoNivel=
...
<html lang="en">
<head>
    <link rel="icon" type="image/png" href="images/DB_16x16.png">
    <meta charset="utf-8">
                ...
                <div class="mdl-card__supporting-text color--dark-gray">
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            ...
                            <span class="login-secondary-text text-color--smoke">Distribuidora de Dulces & Licores La Candelaria</span>
                        </div>
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
